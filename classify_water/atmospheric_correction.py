...
def atmospheric_correction(calibrated_envi_img, calibrated_np_array):
    avg_intercept, avg_slope = find_correlation(calibrated_envi_img)
...
def find_correlation(calibrated_envi_img):
    water_pixel_1  = calibrated_envi_img.read_pixel(780,300)[4:]
    water_pixel_2  = calibrated_envi_img.read_pixel(600,607)[4:] 
    water_pixel_3  = calibrated_envi_img.read_pixel(400,20)[4:]  
