...
class Hypso1DataAnalysis:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'Hypso1DataAnalysis_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Hypso-1 Data Analysis')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('Hypso1DataAnalysis', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/hypso_1_data_analysis/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u''),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Hypso-1 Data Analysis'),
                action)
